# Budget analysis and financial forecasting - High Complexity
...
```
# Nonprofit Budget Analysis & Financial Forecasting Template (High Complexity)
...
<CONTEXT>
Nonprofit financial analysis differs from for-profit analysis in several important ways:

1. **Mission-Driven Focus**: Financial decisions must support mission impact, not just financial returns
...
Common financial challenges for nonprofits include:
...
2. **Program Fee Optimization**
   - Implement sliding scale fee structure while maintaining accessibility
   - Add premium program options with enhanced features
   - Resource requirements: Financial aid fund ($15,000), registration system update ($3,000)
   - Timeline: Test in summer programs, full implementation within 8 months
   - Expected outcome: Increase earned income by 35% while maintaining program access

### Example #2: Medium-Sized Human Services Organization

**Input:**
- 5 years of financial data for Family Support Network
- Current budget: $2.3 million annually
- 55% government contracts, 25% foundation grants, 15% individual giving, 5% events
- Strategic priority to build financial resilience while maintaining service levels
- Operating at slight deficit for past two years
- Staff turnover causing program delivery challenges
- Board requesting 3-month operating reserve within 18 months

**Analysis Thought Process:**
1. Examined contract reimbursement timing causing cash flow issues
2. Calculated true costs of service delivery vs. contract funding rates
3. Analyzed program margins to identify cross-subsidization
4. Reviewed salary competitiveness as factor in turnover
5. Modeled reserve building scenarios with different funding allocations
6. Assessed fundraising return on investment by channel
...
##### Scenario 2: Moderate Growth
**Key Assumptions:**
- Government contracts increase by 3% annually (inflation adjustment)
- Foundation funding remains stable with 80% renewal rate
- Individual giving grows 10% annually through donor retention improvements
- Salary adjustments of 4% to address competitive market
- Indirect cost recovery improves from 12% to 15% on new contracts

**3-Year Financial Projections:**
- Year 1: $2.35M revenue, $2.33M expenses, $20K surplus (0.9% margin)
- Year 2: $2.48M revenue, $2.45M expenses, $30K surplus (1.2% margin)
- Year 3: $2.62M revenue, $2.56M expenses, $60K surplus (2.3% margin)
- Operating reserve: $150K (Year 1), $250K (Year 2), $400K (Year 3)

**Critical Success Factors:**
- Renegotiation of largest government contract to improve terms
- Development of major gifts program targeting 15 prospects
- Implementation of shared services model for administrative functions
- Improved grant management system to ensure compliance and renewal
- Staff retention improvements through compensation and development
</FEW_SHOT_EXAMPLES>
...
- **Health Organizations**: Emphasize patient/client service unit economics, insurance reimbursement cycles, and compliance costs
- **Educational Nonprofits**: Focus on enrollment trends, tuition/fee structures, and academic year cash flow patterns
- **Advocacy Organizations**: Address campaign funding cycles, membership models, and policy-driven funding fluctuations
- **Arts & Cultural Organizations**: Highlight earned income opportunities, attendance trends, and facility maintenance costs
- **International Development**: Include currency risk management, country-specific funding restrictions, and global compliance requirements

### For Different Organization Sizes:
- **Small Organizations (<$1M budget)**: Simplify scenarios, focus on core sustainability metrics, and emphasize volunteer resource allocation
- **Medium Organizations ($1-10M budget)**: Balance program growth with infrastructure investment and develop departmental accountability
- **Large Organizations (>$10M budget)**: Include program portfolio analysis, enterprise risk management, and complex revenue modeling

### For Different Financial Situations:
- **Financial Distress**: Emphasize short-term cash management, critical path to stability, and stakeholder communication
- **Stable but Stagnant**: Focus on strategic investments, innovation funding, and breaking growth barriers
- **Growth Phase**: Address scaling challenges, infrastructure needs, and maintaining quality during expansion
- **Mature/Established**: Highlight reinvention opportunities, legacy program assessment, and long-term sustainability

### Troubleshooting Tips:
- If financial data is incomplete, specify assumptions made and request additional information
- If forecasts seem unrealistic, revisit growth assumptions and external environment factors
- If recommendations lack specificity, focus on 2-3 highest impact areas with detailed action steps
- If mission alignment is unclear, explicitly connect financial strategies to program outcomes
- If implementation seems overwhelming, break recommendations into phased approach with clear priorities

### Model Selection:
- Use ChatGPT-o3 for this template as it requires complex financial reasoning and strategic thinking
- For simpler budget variance analysis, ChatGPT-4.1 may be sufficient
- For comprehensive strategic financial planning, consider multiple sessions with ChatGPT-o3
```
