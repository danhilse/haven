# Financial document verification - High Complexity
...
- **Inconsistent Results**: Ensure verification criteria are specific and objective
- **Overly Strict Verification**: Adjust constraints to match your organization's risk tolerance
- **Missing Context**: Add organization-specific policies to the CONTEXT section
- **Incomplete Feedback**: Ensure the RECOMMENDED ACTIONS section provides clear next steps

### Measuring Effectiveness

Track these metrics to evaluate the template's impact:
1. Reduction in document processing time
2. Decrease in rejected or returned documents
3. Improved compliance with funder requirements
4. Reduction in audit findings
5. Staff time saved on financial document review

This template is designed to be adapted to your specific nonprofit's needs while maintaining consistent verification standards across all financial documents.
```
